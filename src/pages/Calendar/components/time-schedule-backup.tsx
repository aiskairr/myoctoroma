...
const AdvancedScheduleComponent: React.FC<AdvancedScheduleComponentProps> = ({ initialDate }) => {
    ...
    useEffect(() => {
        if (initialDate) {
            console.log('📅 TimeSchedule - updating currentDate from initialDate:', initialDate.toISOString());
    ...
    const dateString = useMemo(() => {
        ...
        console.log('📅 TimeSchedule - dateString updated:', formattedDate, 'from currentDate:', currentDate.toISOString());
